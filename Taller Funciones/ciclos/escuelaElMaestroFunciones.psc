SubProceso registroUsuario(nomb1 Por Referencia,nomb2 Por Referencia,nomb3 Por Referencia,nomb4 Por Referencia,nomb5 Por Referencia,nomb6 Por Referencia,nomb7 Por Referencia,nomb8 Por Referencia,edad1 Por Referencia,edad2 Por Referencia,edad3 Por Referencia,edad4 Por Referencia,edad5 Por Referencia,edad6 Por Referencia,edad7 Por Referencia,edad8 Por Referencia)
	Limpiar Pantalla;
...
SubProceso asignarNota(nomb1,nomb2,nomb3,nomb4,nomb5,nomb6,nomb7,nomb8,nota1 Por Referencia,nota2 Por Referencia,nota3 Por Referencia,nota4 Por Referencia, nota5 Por Referencia,nota6 Por Referencia,nota7 Por Referencia,nota8 Por Referencia)
...
SubProceso consultarEstudiantes(nomb1,nomb2,nomb3,nomb4,nomb5,nomb6,nomb7,nomb8,edad1, edad2, edad3, edad4, edad5, edad6, edad7, edad8,nota1,nota2,nota3,nota4, nota5,nota6,nota7,nota8)
	Limpiar Pantalla;
...
Proceso escuelaAutoElMaestroFunciones
	...
	Repetir
		...
		segun opcion hacer
			1:
				registroUsuario(nomb1,nomb2,nomb3,nomb4,nomb5,nomb6,nomb7,nomb8,edad1, edad2, edad3, edad4, edad5, edad6, edad7, edad8);
				
			2:
				asignarNota(nomb1,nomb2,nomb3,nomb4,nomb5,nomb6,nomb7,nomb8,nota1,nota2,nota3,nota4, nota5,nota6,nota7,nota8);
			3:
				consultarEstudiantes(nomb1,nomb2,nomb3,nomb4,nomb5,nomb6,nomb7,nomb8,edad1, edad2, edad3, edad4, edad5, edad6, edad7, edad8,nota1,nota2,nota3,nota4, nota5,nota6,nota7,nota8);
			4:
				Limpiar Pantalla;
				Escribir  "";
				escribir "";
