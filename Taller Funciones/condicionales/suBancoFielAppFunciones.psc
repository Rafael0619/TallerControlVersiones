SubProceso ingresos(titular1,titular2, titular3, cantidad1, cantidad2, cantidad3)
...
SubProceso retiros(titular1,titular2, titular3, cantidad1, cantidad2, cantidad3)
	Definir titular Como Caracter;
	definir cantidad como Real;
	Limpiar Pantalla;
	escribir "Digite su primer nombre y primer apellido para validar que pertenece a su banco Fiel";
...
SubProceso listadoCuentas(titular1,titular2, titular3)
...
Proceso suBancoFielAppFunciones
	...
	segun opcion hacer
		1:
			ingresos(titular1,titular2, titular3, cantidad1, cantidad2, cantidad3);
		2:
			retiros(titular1,titular2, titular3, cantidad1, cantidad2, cantidad3);
		3:
			listadoCuentas(titular1,titular2, titular3);
		De Otro Modo:
