...
SubProceso historialArreglos(repuesto1,repuesto2,repuesto3,repuesto4,repuesto5)
	Limpiar Pantalla;
...
Proceso motosElMaquinistaFuncion
	definir repuesto1, repuesto2, repuesto3, repuesto4, repuesto5 Como Caracter;
	...
	segun opcion hacer
		...
		2:
			salidaTaller();
		3:
			historialArreglos(repuesto1,repuesto2,repuesto3,repuesto4,repuesto5);
		De Otro Modo:
